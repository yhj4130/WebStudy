...
<%
	...
	try
	{
		...
		// 조현우 입사일 부분
			...
			System.out.println(request.getParameter("Empno")+"5");
			...
			System.out.println(request.getParameter("Empno")+"6");
			...
			System.out.println(request.getParameter("Empno")+"7");
			...
			System.out.println(request.getParameter("Empno")+"8");
			...
			System.out.println(request.getParameter("Empno")+"9");
		    ...
		    {
		    	if (testdept==null && Edept.equals(deptD.getdName()))
		    	{
		    ...
		    System.out.println(request.getParameter("Empno")+"10");
		    ...
		    for (int i=0; i<4; i++)
		    {
		    	if (jobStr == null && Ejob.equals(jobs[i]))
		    	{
		    		jStr.append("<option value = '"+ jobs[i] +"' selected = 'selected'>"+ jobs[i] +"</option>");	
		    	}		    	
		    	else if (jobStr!=null && jobStr.equals(jobs[i]))
		        {
	...
	function empSubmit()
	   {
	      ...
	      /* 
	      */
	      location.href="EmpUpdate.jsp?dept="+dept+"&selectY="+selectY+"&selectM="+selectM+"&selectD="
